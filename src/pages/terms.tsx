  ...
  },
  {
    ...
    text: [
      ...
      [
        ...
        'Получать дополнительную информацию о процессах и алгоритмах работы Сервиса или другие инструкции по работе с Системой reflexity.com;',
        'Пользоваться услугами приема и выплаты платежей Системы reflexity.com;',
  ...
  },
  {
    ...
    text: [
      ...
      [
        ...
        'Не использовать услуги системы reflexity.com с целью реализации товаров или услуг запрещенных в РФ, а также противоречащих моральным или этическим нормам;',
