...
const navMenu = [
  {
    ...
    link: '#introduction',
    text: [
      '1. На данной странице размещены основные правила, соглашения, особенности (далее - Документ) работы с Paykins.com (далее - Сервис).',
      ...
      '3. Документ представляет собой оферту Сервиса с строго прописанными правилами, соглашениями и вступает в законную силу с момента регистрации Клиента на Сервисе Paykins.com.',
      '4. Дополнительные услуги Сервиса, не прописанные в данном Документе, но вызванные запросом Клиента, при обращении к сервису, могут быть предоставлены Клиенту, если на то возникнут существенные основания, и только по его личному желанию, высказанному его личному менеджеру Сервиса Paykins.',
    ],
  },
  {
    ...
    text: [
      <>
        ...
        Paykins.com, пользующееся услугами Сервиса.
      </>,
      <>
      ...
      <>
        ...
        личном кабинете Paykins.com, Гарант честных сделок между Трейдером и
  ...
  },
  {
    ...
    text: [
      'Система Paykins - это сервис-посредник между Трейдером и Клиентом (далее Сервис), предоставляющий автоматизацию сделок, взаиморасчетов между физическими лицами и/или юридическими лицами. Выступает гарантом честного выполнения своих финансовых и временных обязательств каждой из сторон.',
      ...
      'Сервис имеет право в одностороннем порядке вносить изменения в настоящий Договор путем публикации изменений на сайте Paykins.com. Изменения вступают в силу с момента опубликования, если иной срок вступления изменений в силу не определен дополнительно при их публикации.',
    ],
  },
  {
    title: 'Права сторон',
    ...
    text: [
      ...
      [
        'Получить полную техническую - поддержку на этапе интеграции Сервиса Paykins.com;',
  ...
  },
  {
    ...
    text: [
      ...
      [
        ...
        'Вносить корректные данные при совершении транзакций, создании заявок внутри Сервиса Paykins;',
  ...
  },
  {
    ...
    link: '#paymentMethods',
    text: [
      'Методы оплаты, доступны в системе Paykins указаны в личном кабинете Клиента. Сервис имеет право в одностороннем порядке вносить изменения в перечень Методов оплаты без обязательного предварительного уведомления Клиента.',
  ...
  },
  {
    ...
    text: [
      'Стоимость финансовых услуг по приему платежей при помощи системы Paykins и лимиты по каждому Методу оплаты указаны в соответствующем разделе личного кабинета Клиента. Сервис оставляет за собой право менять тарифы и/или лимиты в одностороннем порядке.',
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      <>
        ...
        веб-сайте <a href='https://paykins.com'>https://paykins.com.</a>
      </>,
