  ...
  const featuresPreviewConfigs = [
    {
      ...
      text: 'Это интеллектуальная система саморефлексии, которая анализирует ваши записи, эмоции и действия, превращая хаос мыслей в ясную картину вашей личности.',
    },
    {
      ...
      reverseLayout: true,
      title: 'Визуализируйте сферы жизни',
      text: 'Каждая запись, цель или эмоция становится частью когнитивной карты — живой модели вашей личности. С каждым днём Reflexity узнаёт вас лучше, и когда карта становится достаточно полной — начинается настоящая магия.',
    },
    {
      targetScreenNumber: '4',
      videoSrc: '/assets/SimulatorChat.webm',
      videoPoster: '/assets/SimulatorChatPoster.png',
      title: 'Общайтесь с экспертом вашей жизни',
      text: 'Это не просто "чат с ботом" — это нейросистема нового поколения, которая обучается на ваших данных, понимает контекст вашей жизни, адаптируется под ваши особенности и находит именно тот подход, который работает для вас.',
    },
    {
      ...
      reverseLayout: true,
      title: 'Достигайте целей с лёгкостью',
      text: 'Reflexity поможет сформулировать цель и построит индивидуальный пошаговый план с учётом ваших возможностей, ритма жизни и обстоятельств, чтобы найти самый комфортный маршрут к её достижению.',
    },
    {
      ...
      text: 'Reflexity выявляет ваши сильные стороны, скрытые таланты и предрасположенности. Формируйте детальные саммари по любым темам — и воплощайте инсайты в жизнь.',
    },
  ]
