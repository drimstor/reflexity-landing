...
# Переменные окружения для сборки (встраиваются в код при сборке)
ARG NEXT_PUBLIC_TELEGRAM_CHANNEL_ID
ARG NEXT_PUBLIC_TELEGRAM_BOT_TOKEN
ARG NEXT_PUBLIC_AMPLITUDE_KEY

ENV NEXT_PUBLIC_TELEGRAM_CHANNEL_ID=$NEXT_PUBLIC_TELEGRAM_CHANNEL_ID
